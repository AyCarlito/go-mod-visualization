...
PULL_REQUEST_BASE="https:\/\/github.com\/AyCarlito\/go-mod-visualization\/pull"
...
# Consider the pattern (#19), we replace it with "[#19](https://github.com/AyCarlito/go-mod-visualization/pull/19)".
