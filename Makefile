# Setting SHELL to bash allows bash commands to be executed by recipes.Add commentMore actions
...
fmt: goimports ## Run goimports against code.
	...
	$(LOCALBIN)/goimports -local github.com/AyCarlito/go-mod-visualization -w -e -format-only .
